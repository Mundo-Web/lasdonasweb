    ...
    return (
        <>
            <section className="flex flex-col px-[5%] lg:px-[8%] py-12 md:py-20">
                <div className="flex relative flex-col items-start max-w-full w-[392px] font-b_classic_regular">
                    <img
                        loading="lazy"
                    ...
                    <div className="flex z-0 flex-col self-stretch mt-4 w-full">
                        ...
                        <div className="flex gap-4 items-center mt-1 w-full text-lg text-neutral-900 text-opacity-80">
                            <p className="self-stretch my-auto">ademir@mail.com</p>
                ...
                <div className='mt-10'>
                    {selectedOption === 'Mi Perfil' && <Profile />}
