...
function QuantitySelector({ quantity, Qadd, Qdelete }) {
  return (
    <div className="flex gap-1 text-xs items-center self-start p-2 mt-5 text-lg font-medium text-white whitespace-nowrap bg-green-400 rounded-3xl min-h-[40px]">
      ...
      <span className="px-2 w-6 text-xs">{quantity}</span>
