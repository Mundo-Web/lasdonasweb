  ...
  return (
    <div className="flex flex-col mt-1 w-full max-md:max-w-full">
      ...
      <input
        ...
        className={`gap-2 self-stretch px-6 py-4 mt-1 w-full text-sm tracking-wide rounded-3xl border border-[#BDBDBD] focus:ring-0 focus:outline-none focus:border-[#336234] ${isError ? 'border-red-500' : 'border-[#BDBDBD]'} max-md:px-5 max-md:max-w-full`}
      />
