        ...
        <div className="flex flex-col w-full max-md:max-w-full">
          <div className="flex flex-col w-full max-md:max-w-full">
            <div className="flex flex-col w-full text-sm max-md:max-w-full">
              <label htmlFor="name" className="tracking-wide text-neutral-900">Nombre completo</label>
            ...
            <div className="flex flex-wrap gap-3 items-start mt-5 w-full max-md:max-w-full">
              <div
                ...
                <label htmlFor="phone" className="tracking-wide text-neutral-900">Teléfono</label>
              ...
              <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px] max-md:max-w-full">
                <label htmlFor="direccion" className="tracking-wide text-neutral-900">Dirección 1</label>
            ...
            <div className="flex flex-wrap gap-5 items-start mt-5 w-full text-sm max-md:max-w-full">
              <div className="flex flex-col flex-1 shrink whitespace-nowrap basis-0 min-w-[240px] max-md:max-w-full">
                <label htmlFor="departamento" className="tracking-wide text-neutral-900">Departamento</label>
              ...
              <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px] max-md:max-w-full">
                <label htmlFor="codigo_postal" className="tracking-wide text-neutral-900">Código postal</label>
            ...
            <div className="flex flex-wrap gap-5 items-start mt-5 w-full text-sm whitespace-nowrap max-md:max-w-full">
              <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px] max-md:max-w-full">
                <label htmlFor="provincia" className="tracking-wide text-neutral-900">Provincia</label>
              ...
              <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px] max-md:max-w-full">
                <label htmlFor="distrito" className="tracking-wide text-neutral-900">Distrito</label>
            ...
            <div
              ...
              <input type="checkbox" id="rememberDates" className="rounded-md w-5 h-5 ring-0 focus:ring-0 border-[#FF8555] text-[#FF8555]" />
              <label htmlFor="rememberDates" className="flex-1  max-md:max-w-full mt-1 ml-2">
