...
const Oferta = ({ categorias, selected_category, categoria, url_env, beneficios, tipoFloresList }) => {
  const take = 12
  ...
  const getItems = async () => {
    ...
    filterBody.push(['products.descuento', '>', 0]);
...
CreateReactScript((el, properties) => {
  createRoot(el).render(<Oferta {...properties} />);
})