            ...
            <div class="basis-0 md:basis-3/5">
              <div class="rounded shadow-lg p-4 px-4 ">
                ...
                <div id='general' class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                  {{-- <div class="col-span-5 flex flex-row gap-6 items-center">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="checkbox" id="complemento" name="complemento"
                        @if ($product->tipo_servicio == 'complemento') checked @endif
                ...
                <div class="md:col-span-2 mt-2">
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="text" id="opcion-form-sku-{{ $subproducto->id }}" data-name="sku"
