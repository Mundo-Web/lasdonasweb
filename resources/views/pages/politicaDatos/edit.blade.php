<x-app-layout>
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('politicadatos.save') }}" method="POST">
      @csrf
      @method('POST')
      <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
          <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">
            Protocolos de Bio Seguridad </h2>
        </header>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" class="hidden" name="id" value={{ $politicas->id }}>
                  {{-- <x-textarea id="description" name="content" :value="$politicas->content" /> --}}
                  <x-quill id="content" name="content" :value="$politicas->content" />
