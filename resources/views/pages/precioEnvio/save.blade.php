<x-app-layout>
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('precio-envio.save') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('POST')
      <div
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
              ...
              <div class="md:col-span-6">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="direcction" name="direcction" value="{{ $envio->direcction }}"
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="md:col-span-6 text-right mt-6 flex justify-between">
