          ...
          <div class="rounded shadow-lg p-4 px-4 ">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                <label for="subtitle">Pre-título</label>
                <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="subtitle" name="subtitle" value=""
                    class="required:border-red-500 mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="md:col-span-5">
                <label for="title2">Titulo (Primera línea)</label>
                <div class="relative mb-2  mt-2">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                      version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
              ...
              <div class="md:col-span-5">
                <label for="title">Titulo (Segunda línea)</label>
                <div class="relative mb-2  mt-2">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                      version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
              ...
              <div class="md:col-span-5">
                <label for="description">Descripción de slider</label>
                <div class="relative mb-2 mt-2">
              ...
              <div class="md:col-span-5">
                <label for="imagen">Subir imagen (Lado izquierdo)</label>
                <div class="relative mb-2  mt-2">
                  <input name="imagen"
              ...
              <div class="md:col-span-5">
                <label for="imagen2">Subir imagen (Lado derecho)</label>
                <div class="relative mb-2  mt-2">
                  <input name="imagen2"
                    class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    aria-describedby="user_avatar_help" id="user_avatar" type="file">
              ...
              <div class="md:col-span-5">
                <label for="img_mobile">Img para Formato Movil </label>
                <div class="relative mb-2  mt-2">
                  <input name="img_mobile"
                    class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    aria-describedby="user_avatar_help" id="user_avatar" type="file">
                </div>
              </div>
