<x-app-layout>
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <section class="py-4 border-b border-slate-100 dark:border-slate-700">
      <a href="{{ route('tipo-flor.create') }}"
        class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-sm">Agregar Tipos de
        Flor</a>
    </section>
    ...
    <div
      ...
      <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Tipos de Flor</h2>
      </header>
      <div class="p-3">
              ...
              @foreach ($tipos as $item)
                <tr>
                  ...
                  <td class="flex flex-row justify-end items-center gap-5">
                    ...
                    <a href="{{ route('tipo-flor.edit', $item->id) }}"
