  ...
  <div
    ...
    <main>
      ...
      <p style="font-size: 18px; margin-bottom: 20px">
        ...
        Ahora, nuestro equipo está manos a la obra para crear un
      ...
      <p style="font-size: 18px; margin-bottom: 20px">
        ...
        que podrás canjear en tu próximo pedido por complementos
        como globos, chocolates o peluches, ¡y hacer de tu regalo
