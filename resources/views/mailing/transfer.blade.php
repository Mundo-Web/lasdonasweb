  ...
  <div
    ...
    <main>
      ...
      <div
        ...
        <p style="font-size: 16px; margin-bottom: 10px">Ó</p>
      ...
      <div
        ...
        <p style="font-size: 16px">SCOTIABANK: 151-0020074</p>
      </div>
      <div>
        <h2
          style="
            ...
            <tbody style="font-size: 14px">
              @foreach ($productos as $item)
                <tr>
                  ...
                  <td style=" padding: 8px;">{{ $item->precio }} x {{ $item->cantidad }} </td>
                  <td style=" padding: 8px;">{{ $item->precio * $item->cantidad }}</td>
                </tr>
              @endforeach
              <tr>
                ...
                <td style=" padding: 8px;">{{ $sale->monto }}</td>
              </tr>
              <tr>
                <td style=" padding: 8px;"></td>
                <td style=" padding: 8px;"></td>
                <td style=" padding: 8px; text-align: left;">Envío:</td>
                <td style=" padding: 8px;">{{ $sale->precio_envio }}</td>
              </tr>
              <tr>
                <td style=" padding: 8px;"></td>
                <td style=" padding: 8px;"></td>
                <td style=" padding: 8px; text-align: left;">Total:</td>
                <td style=" padding: 8px;">{{ $sale->monto + $sale->precio_envio }}</td>
              </tr>
            </tbody>
          </table>
        </div>
