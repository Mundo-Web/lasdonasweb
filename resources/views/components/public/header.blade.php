...
<header class="font-Inter_Regular">
  ...
  <div
    ...
    Producto | Categoría <span class="ml-1 font-bold"> más vendida </span> <img
  ...
  <div>
    <div id="header-menu" class="flex justify-between gap-5 w-full px-[5%] xl:px-[8%] py-6  text-[17px] relative">
      ...
      <div class="flex justify-end md:w-auto md:justify-center items-center gap-2">
        ...
        <div class="relative w-full lg:w-80 lg:py-0 border-b lg:border-0 border-[#082252] mr-3 hidden lg:flex">
